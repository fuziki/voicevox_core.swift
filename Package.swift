...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "VoicevoxCore",
            url: "https://github.com/fuziki/voicevox_core/releases/download/0.15.0-preview.1/voicevox_core-ios-xcframework-cpu-0.15.0-preview.1.zip",
            checksum: "503ff9f958b61c5c60223012d90428d7a59b07b8abfacbad29bac0d108d8b669"),
    ]
)
